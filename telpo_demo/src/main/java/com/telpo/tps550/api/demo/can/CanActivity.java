    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btn_can_open:
                ...
                if(!str.isEmpty()) {
                    Toast.makeText(this, CanUtil.open(Integer.valueOf(str)) + "", Toast.LENGTH_SHORT).show();
                }
                CanUtil.canRecv(new CanOperationListener() {
...
//                        Log.d("tagg", " can id: " + canRecvInfo.getRecvId()+" Data: " + StringUtil.toHexString(canRecvInfo.getRecvData()));
            ...
            case R.id.btn_can_close:
                Toast.makeText(this, CanUtil.close()+"", Toast.LENGTH_SHORT).show();
                tv_candump.setText("");
                break;
            case R.id.btn_get_can_status:
                int status = CanUtil.getStatus();
            ...
            case R.id.btn_cansend_data:
                ...
                int ret = CanUtil.canSend(formatPosition, typePosition, idStr, data);
